...
class Rentify_Core {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Rentify_Core_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'RENTIFY_CORE_VERSION' ) ) {
			$this->version = RENTIFY_CORE_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'rentify-core';
	 ...
	 *
	 * - Rentify_Core_Loader. Orchestrates the hooks of the plugin.
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-rentify-core-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-rentify-core-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-rentify-core-admin.php';
	 ...
	 *
	 * Uses the Rentify_Core_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Rentify_Core_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Rentify_Core_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Rentify_Core_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Rentify_Core_Loader    Orchestrates the hooks of the plugin.
	 */
